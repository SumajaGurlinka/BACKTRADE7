...
const Profile = (props) => {
  const { getEditAsync,getPhoneAsync,edit
  } = props;
  ...
  const handleSaveClick1 = async () => {
    ...
    try {
      ...
      console.log("de");
      toast.success("Email number has been updated sucessfully");
    } catch (error) {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      console.log("de");
      toast.success("Phone number has been updated sucessfully");
    } catch (error) {
      toast.error("There is an issue while updating details");
    }
    setIsEditing(false);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Grid item xs={5} sm={5}>
            <div style={{fontWeight:"bold",fontSize:"18px",marginTop:"8px"}}>Email</div>
          </Grid>
      ...
      <Grid item xs={12} sm={5}>
        ...
        >
          <Grid item xs={5} sm={5}>
            <div style={{fontWeight:"bold",fontSize:"18px",marginTop:"8px"}}>Phone</div>
          </Grid>
          <Grid container alignItems="center">
      <Grid item xs={12} sm={7}>
        {isEditing ? (
