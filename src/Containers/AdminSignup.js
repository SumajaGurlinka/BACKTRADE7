...
import useMediaQuery from "@mui/material/useMediaQuery";
    ...
    return (
      <>
        ...
        <Paper className="login_form_container">
         ...
         <Grid container>   <Grid item xs={12} sm={6} sx={{ marginRight: isMobile ? 0 : '8px' }}>
         ...
         <Typography sx={{ marginBottom: "6px" }} required>
          ...
          <TextField
            ...
            error={
              ...
              !isNameValid(formValues.firstname.value) ||
  ...
  error={
    ...
    !isNameValid(formValues.lastname.value)
  }
  helperText={
    formValues.lastname.error
  ...
  onChange={handleChange}
  required
  error={formValues.phoneNumber.error || !isPhoneNumberValid(formValues.phoneNumber.value)||
